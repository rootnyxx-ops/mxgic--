...
Route::group(['prefix' => 'ai'], function () {
    Route::get('/', [Admin\AiSettingsController::class, 'index'])->name('admin.ai.index');
    Route::post('/', [Admin\AiSettingsController::class, 'update'])->name('admin.ai.update');
});